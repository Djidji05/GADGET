  ...
  >
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
      ...
      <div class="flex items-center gap-2 w-full sm:w-auto">
        <button
          @click="loadOrders"
          class="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 transition-colors"
        >
          <svg class="stroke-current" width="16" height="16" viewBox="0 0 20 20" fill="none">
            <path d="M17.7 8.5C17.1 5.2 14.3 2.7 11 2.7C7.7 2.7 4.9 5.2 4.3 8.5M2.3 11.5C2.9 14.8 5.7 17.3 9 17.3C12.3 17.3 15.1 14.8 15.7 11.5" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        ...
        <router-link
          to="/commandes"
          class="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 transition-colors"
        >
          Voir Tout
        </router-link>
      </div>
