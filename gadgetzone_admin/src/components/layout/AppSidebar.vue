...
const fetchNotificationStats = async () => {
  ...
  try {
    if (role === 'seller') {
      ...
      notificationStats.value = { ...notificationStats.value, ...data };
    } else {
    ...
    items: [
      {
        ...
        subItems: [
          ...
          { name: "Ventes Flash", path: "/marketing/flash-sales" },
        ],
      },
      {
        icon: PageIcon,
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: "Pages du site (CGU, etc.)", path: "/parametres/pages" },
...
const nameToKey: Record<string, string> = {
  ...
  "Pages du site (CGU, etc.)": "sitePages",
  "Ventes Flash": "flashSales",
